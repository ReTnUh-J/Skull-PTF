...
[ $UID -ne '0' ] && { echo "Root Access Required."; exit 1 ;}

export LANG=en_us.UTF-8
zenity --title="Skull Tools Listing" --info --width=400 --height=200 --text=" [SKULL] It is a script that downloads the source code of all the tools available in Kali Linux, straight from its official repositories, and from trusted repositories. Moreover, other tools are available straight from there official site such as Sourceforge , PlayStore "
...
banner
echo ""
echo -e  "$red    Tools: $white ⚛  +300 $yellow||$red By @mahmoudakram $yellow ||$red Skull-PTF "



echo -e "\t\t\t$yellow Skull v2.0\n"
echo -e "\t$red[/info]$yellow[[$white Information Gathering  $yellow]] $white: "
echo -e "\t$red[/vuln]$yellow[[$white Vulnerability Analysis $yellow]] $white: "
...
echo -e "\t$red[/nfrf]$yellow[[$white   NFC & RFID Hacking   $yellow]] $white: "
echo -e "\t$red[/spyw]$yellow[[$white     Spyware Tools      $yellow]] $white: "
echo -e "\t$red[/sfdf]$yellow[[$white Software Defined Radio $yellow]] $white: "
echo -e "\t$red[/voic]$yellow[[$white     Voice Cloning      $yellow]] $white: "
echo -e "\t$red[/dron]$yellow[[$white      Drone Tools       $yellow]] $white: "
echo -e "\t$red[/repo]$yellow[[$white    Reporting Tools    $yellow]] $white: "
echo -e "\t$red[/exit] $yellow[$white          Exit          $yellow]] $white: "
echo -e "\t$red Choose An Option [/$yellow*$red]?"
echo -e "$white"
echo -e $lightgreen" ┌─["$red"Skull $okegreen]──[$red~$lightgreen]─["$yellow"Home$lightgreen]:"
...
spyw|/spyw) Spyware ;;
sfdf|/sfdf) SoftwareD ;;
voic|/voic) VoiceCloning ;;  
dron|/dron) Drone ;; 
repo|/repo) Reporting ;;
exit|/exit) Exit;;
*) echo -e $yellow'invalid option, please try again!'&&sleep 2&&menu;;
esac
}
echo -e "$white"
...
banner
echo ""
echo -e  "$red        Tools: $white ⚛ 66 $yellow||$red By @mahmoudakram"
...
echo -e "\t$red[/menu]$yellow[[$white Return to Menu$yellow]] $white: "
...
echo -e "$lightgreen""+-+-+-+-+-+-+-+-+-+-+-+ +-+-+-+-+-+-+-+-+-+ "
echo -e $ [!] $yellow'Check out the Tool in the Directory' $lightgreen "/Skull" &&sleep 2 &&Information
;;
...
mkdir arp-scan
clear
echo -e "$yellow""arp-scan is a command-line tool that uses the ARP protocol to discover and fingerprint IP hosts on the local network"
cd arp-scan/
...
banner
echo ""
echo -e  "$red         Tools: $white ⚛ 27 $yellow||$red By @mahmoudakram"
...
echo -e "$lightgreen""+-+-+-+-+-+-+-+-+-+-+-+ +-+-+-+-+-+-+-+-+-+ "
echo -e $ [!] $yellow'Check out the Tool in the Directory' $lightgreen "/Skull" &&sleep 2 &&Vulnerability
;;
...
banner
echo ""
echo -e  "$red       Tools: $white ⚛ 50 $yellow||$red By @mahmoudakram"
...
echo -e "$lightgreen""+-+-+-+-+-+-+-+-+-+-+-+ +-+-+-+-+-+-+-+-+-+ "
echo -e $ [!] $yellow'Check out the Tool in the Directory' $lightgreen "/Skull" &&sleep 2 &&Wireless
;;
...
banner
echo ""
echo -e  "$red        Tools: $white ⚛ 43 $yellow||$red By @mahmoudakram"
...
echo -e "$lightgreen""+-+-+-+-+-+-+-+-+-+-+-+ +-+-+-+-+-+-+-+-+-+ "
echo -e $ [!] $yellow'Check out the Tool in the Directory' $lightgreen "/Skull"  &&sleep 2 &&Web
;;
...
banner
echo ""
echo -e  "$red        Tools: $white ⚛ 21 $yellow||$red By @mahmoudakram"
...
echo -e "$lightgreen""+-+-+-+-+-+-+-+-+-+-+-+ +-+-+-+-+-+-+-+-+-+ "
echo -e $ [!] $yellow'Check out the Tool in the Directory' $lightgreen "/Skull"  &&sleep 2 &&Exploitation
;;
...
banner
echo ""
echo -e  "$red         Tools: $white ⚛ 14 $yellow||$red By @mahmoudakram"
...
echo -e "$lightgreen""+-+-+-+-+-+-+-+-+-+-+-+ +-+-+-+-+-+-+-+-+ "
echo -e $ [!] $yellow'Check out the Tool in the Directory' $lightgreen "/Skull" &&sleep 2 &&Stress
;;
...
banner
echo ""
echo -e  "$red        Tools: $white ⚛ 23 $yellow||$red By @mahmoudakram"
...
echo -e "$lightgreen""+-+-+-+-+-+-+-+-+-+-+-+ +-+-+-+-+-+-+-+-+ "
echo -e $ [!] $yellow'Check out the Tool in the Directory' $lightgreen "/Skull" &&sleep 2 &&Forensics
;;
...
banner
echo ""
echo -e  "$red        Tools: $white ⚛ 33  $yellow||$red By @mahmoudakram"
...
echo -e "$lightgreen""+-+-+-+-+-+-+-+-+-+-+-+ +-+-+-+-+-+-+-+-+ "
echo -e $ [!] $yellow'Check out the Tool in the Directory' $lightgreen "/Skull" &&sleep 2 &&Sniffing
;;
...
banner
echo ""
echo -e  "$red         Tools: $white ⚛ 38  $yellow||$red By @mahmoudakram"
...
echo -e "$lightgreen""+-+-+-+-+-+-+-+-+-+-+-+ +-+-+-+-+-+-+-+-+ "
echo -e $ [!] $yellow'Check out the Tool in the Directory' $lightgreen "/Skull" &&sleep 2 &&Password
;;
...
banner
echo ""
echo -e  "$red        Tools: $white ⚛ 17  $yellow||$red By @mahmoudakram"
...
echo -e "$lightgreen""+-+-+-+-+-+-+-+-+-+-+-+ +-+-+-+-+-+-+-+-+ "
echo -e $ [!] $yellow'Check out the Tool in the Directory' $lightgreen "/Skull" &&sleep 2 &&Maintaining
;;
...
banner
echo ""
echo -e  "$red        Tools: $white ⚛ 12  $yellow||$red By @mahmoudakram"
...
echo -e "\t$red[12]$yellow[[$white Radare2                $yellow]] $white: "
echo -e "\t$red[/menu]$yellow[[$white Return to Menu    $yellow]] $white: "
...
echo -e "$lightgreen""+-+-+-+-+-+-+-+-+-+-+-+ +-+-+-+-+-+-+-+-+ "
echo -e $ [!] $yellow'Check out the Tool in the Directory' $lightgreen "/Skull" &&sleep 2 &&Reverse
;;
...
mkdir Radare2
cd  Radare2/
sudo git clone https://github.com/radareorg/radare2.git
clear 
cd ..
echo -e "$lightgreen""+-+-+-+-+-+-+-+-+-+-+-+ +-+-+-+-+-+-+-+-+ "
echo -e "$red""   |R|e|v|e|r|s|e| |E|n|g|i|n|e|e|r|i|n|g|"
...
banner
echo ""
echo -e  "$red        Tools: $white ⚛ 6  $yellow||$red By @mahmoudakram"
...
echo -e "$lightgreen""+-+-+-+-+-+-+-+-+-+-+-+ +-+-+-+-+-+-+-+-+ "
echo -e $ [!] $yellow'Check out the Tool in the Directory' $lightgreen "/Skull" &&sleep 2 &&Hardware
;;
...
banner
echo ""
echo -e  "      $red Tools: $white ⚛ 10  $yellow||$red By @mahmoudakram"
...
echo -e "$lightgreen""+-+-+-+-+-+-+-+-+-+-+-+ +-+-+-+-+-+-+-+-+ "
echo -e $ [!] $yellow'Check out the Tool in the Directory' $lightgreen "/Skull" &&sleep 2 &&Reporting
;;
...
banner
echo ""
echo -e  "$red         Tools: $white ⚛ 13 $yellow||$red By @mahmoudakram"

echo ""
echo -e "\t$red[1]$yellow [[$white MifareClassicTool       $yellow]] $white: "
echo -e "\t$red[2]$yellow [[$white EMVemulator             $yellow]] $white: "
echo -e "\t$red[3]$yellow [[$white NFC Spy                 $yellow]] $white: "
echo -e "\t$red[4]$yellow [[$white NFC Proxy               $yellow]] $white: "
echo -e "\t$red[5]$yellow [[$white NFC Host Card Emulation $yellow]] $white: "
echo -e "\t$red[6]$yellow [[$white VirtualJavaScriptCard   $yellow]] $white: "
echo -e "\t$red[7]$yellow [[$white Host Card Emulation     $yellow]] $white: "
echo -e "\t$red[8]$yellow [[$white Virtual Pki Card        $yellow]] $white: "
echo -e "\t$red[9]$yellow [[$white SwipeYours              $yellow]] $white: "
echo -e "\t$red[10]$yellow[[$white POS Proxy               $yellow]] $white: "
echo -e "\t$red[11]$yellow[[$white mfoc                    $yellow]] $white: "
echo -e "\t$red[12]$yellow[[$white NFC MTools              $yellow]] $white: "
echo -e "\t$red[13]$yellow[[$white M Keys [ACR122U]        $yellow]] $white: "
...
1|1) MifareClassicTool 
clear 
mkdir MifareClassicTool
cd MifareClassicTool
curl -O https://github.com/ikarus23/MifareClassicTool/releases/tag/v4.0.4
clear 
cd ..
echo -e "$lightgreen""+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+- "
echo -e "$red""   |N|F|C|      |a|n|d|     |R|F|I|D|"
echo -e "$lightgreen""+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+- "
echo -e $ [!] $yellow'Check out the Tool in the Directory' $lightgreen "/Skull" &&sleep 2 &&NFC-RFID
;;
...
mkdir EMVemulator 
cd EMVemulator
curl -O https://github.com/MatusKysel/EMVemulator/releases/tag/v1.1
clear 
cd ..
echo -e "$lightgreen""+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+- "
echo -e "$red""   |N|F|C|      |a|n|d|     |R|F|I|D|"
...
mkdir NFCSpy 
cd NFCSpy 
curl -O https://github.com/sinpolib/nfcspy/releases/tag/v1.0.150710
clear 
cd ..
echo -e "$lightgreen""+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+- "
echo -e "$red""   |N|F|C|      |a|n|d|     |R|F|I|D|"
...
mkdir NFCProxy 
cd NFCProxy 
curl -O https://sourceforge.net/projects/nfcproxy/
clear 
cd ..
echo -e "$lightgreen""+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+- "
echo -e "$red""   |N|F|C|      |a|n|d|     |R|F|I|D|"
...
5|5) NFCHostCardEmulation
clear 
mkdir NFCHostCardEmulation  
cd NFCHostCardEmulation 
sudo clone https://github.com/championswimmer/NFC-host-card-emulation-Android
clear 
cd ..
echo -e "$lightgreen""+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+- "
echo -e "$red""   |N|F|C|      |a|n|d|     |R|F|I|D|"
...
6|6) VirtualJavaScriptCard
clear 
mkdir VirtualJavaScriptCard 
cd VirtualJavaScriptCard 
sudo clone https://github.com/rena2019/VirtualJavaScriptCard
clear 
cd ..
echo -e "$lightgreen""+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+- "
echo -e "$red""   |N|F|C|      |a|n|d|     |R|F|I|D|"
...
7|7) HostCardEmulation 
clear 
mkdir HostCardEmulation
cd HostCardEmulation 
sudo clone https://github.com/laalaguer/HCE-NFC-Relay-Attack.git
clear 
cd ..
echo -e "$lightgreen""+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+- "
echo -e "$red""   |N|F|C|      |a|n|d|     |R|F|I|D|"
...
8|8) VirtualPKICard 
clear 
mkdir VirtualPKICard
cd VirtualPKICard 
sudo clone https://github.com/eric-erki/virtual-pki-card
clear 
cd ..
echo -e "$lightgreen""+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+- "
echo -e "$red""   |N|F|C|      |a|n|d|     |R|F|I|D|"
...
mkdir SwipeYours
cd SwipeYours 
sudo clone https://github.com/dimalinux/SwipeYours
clear 
cd ..
echo -e "$lightgreen""+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+- "
echo -e "$red""   |N|F|C|      |a|n|d|     |R|F|I|D|"
...
mkdir POSProxy
cd POSProxy 
sudo clone https://github.com/payneteasy/pos-proxy
clear 
cd ..
echo -e "$lightgreen""+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+- "
echo -e "$red""   |N|F|C|      |a|n|d|     |R|F|I|D|"
...
mkdir mfoc
cd mfoc 
sudo clone https://github.com/nfc-tools/mfoc.git
clear 
cd ..
echo -e "$lightgreen""+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+- "
echo -e "$red""   |N|F|C|      |a|n|d|     |R|F|I|D|"
...
mkdir NFC_M_Tools
cd NFC_M_Tools 
curl -O https://play.google.com/store/apps/details?id=tk.toolkeys.mtools&showAllReviews=true 
clear 
cd ..
echo -e "$lightgreen""+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+- "
echo -e "$red""   |N|F|C|      |a|n|d|     |R|F|I|D|"
...
13|13) MKeys[ACR122U]
clear 
mkdir M_Keys_[ACR122U]
cd M_Keys_[ACR122U] 
curl -O https://play.google.com/store/apps/details?id=tk.toolkeys.mtools.keygen 
clear 
cd ..
echo -e "$lightgreen""+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+- "
echo -e "$red""   |N|F|C|      |a|n|d|     |R|F|I|D|"
...
cat <<banner
          ...
          +-+-+-+-+-+-+-+    +-+-+-+-+-+
          |S|p|y|w|a|r|e|    |T|o|o|l|s| 
          +-+-+-+-+-+-+-+    +-+-+-+-+-+  
banner
echo ""
echo -e  "$red         Tools: $white ⚛ 2 $yellow||$red By @mahmoudakram"

echo ""
echo -e "\t$red[1]$yellow [[$white   Pegasus Decompiled     $yellow]] $white: "
echo -e "\t$red[2]$yellow [[$white        AdoBot            $yellow]] $white: "
echo -e "\t$red[3]$yellow [[$white      BlackMamba          $yellow]] $white: "
...
mkdir Pegasus
cd Pegasus
sudo git clone https://github.com/jonathandata1/pegasus_spyware
clear 
cd ..
echo -e "$lightgreen""+-+-+-+-+-+-+-+    +-+-+-+-+-+ "
echo -e "$red""   |S|p|y|w|a|r|e|    |T|o|o|l|s| "
echo -e "$lightgreen""++-+-+-+-+-+-+-+    +-+-+-+-+-+ "
echo -e $ [!] $yellow'Check out the Tool in the Directory' $lightgreen "/Skull" &&sleep 2 &&Spyware
;;
...
mkdir AdoBot
cd AdoBot
sudo git clone https://github.com/adonespitogo/AdoBot.git
clear 
cd ..
echo -e "$lightgreen""+-+-+-+-+-+-+-+    +-+-+-+-+-+ "
echo -e "$red""   |S|p|y|w|a|r|e|    |T|o|o|l|s| "
...
mkdir BlackMamba
cd BlackMamba
sudo git clone https://github.com/loseys/BlackMamba
clear 
cd ..
echo -e "$lightgreen""+-+-+-+-+-+-+-+    +-+-+-+-+-+ "
echo -e "$red""   |S|p|y|w|a|r|e|    |T|o|o|l|s| "
...
banner
echo ""
echo -e  "$red         Tools: $white ⚛ 3 $yellow||$red By @mahmoudakram"

echo ""
echo -e "\t$red[1]$yellow [[$white   SDRPlus Plus    $yellow]] $white: "
echo -e "\t$red[2]$yellow [[$white     GNURadio      $yellow]] $white: "
echo -e "\t$red[2]$yellow [[$white       GQRX        $yellow]] $white: "
...
mkdir SDRPlus
cd SDRPlus
sudo https://github.com/AlexandreRouma/SDRPlusPlus.git 
clear 
cd ..
echo -e "$lightgreen"" +-+-+-+-+-+-+-+-+  +-+-+-+-+-+-+-+  +-+-+-+-+-+ "
echo -e "$red""   |S|o|f|t|w|a|r|e|  |D|e|f|i|n|e|d|  |R|a|d|i|o| "
echo -e "$lightgreen""+-+-+-+-+-+-+-+-+  +-+-+-+-+-+-+-+  +-+-+-+-+-+ "
echo -e $ [!] $yellow'Check out the Tool in the Directory' $lightgreen "/Skull" &&sleep 2 &&SoftwareD
;;
...
mkdir GQRX
cd gqrx
sudo git clone https://github.com/gqrx-sdr/gqrx.git
clear 
cd ..
echo -e "$lightgreen"" +-+-+-+-+-+-+-+-+  +-+-+-+-+-+-+-+  +-+-+-+-+-+ "
echo -e "$red""   |S|o|f|t|w|a|r|e|  |D|e|f|i|n|e|d|  |R|a|d|i|o| "
...
cat <<banner
             ...
             +-+-+-+-+-+   +-+-+-+-+-+-+-+
             |V|o|i|c|e|   |C|l|o|n|i|n|g|  
             +-+-+-+-+-+   +-+-+-+-+-+-+-+
banner
echo ""
echo -e  "$red            Tools: $white ⚛ 1 $yellow||$red By @mahmoudakram"

echo ""
echo -e "\t$red[1]$yellow [[$white   Real Time Voice Cloning    $yellow]] $white: "
...
1|1) RealTimeVoiceCloning 
clear 
mkdir RealTimeVoiceCloning
cd RealTimeVoiceCloning 
sudo git clone https://github.com/CorentinJ/Real-Time-Voice-Cloning.git
clear 
cd ..
echo -e "$lightgreen"" +-+-+-+-+-+   +-+-+-+-+-+-+-+ "
echo -e "$red""   |V|o|i|c|e|   |C|l|o|n|i|n|g| "
echo -e "$lightgreen""+-+-+-+-+-+   +-+-+-+-+-+-+-+ "
echo -e $ [!] $yellow'Check out the Tool in the Directory' $lightgreen "/Skull" &&sleep 2 &&VoiceCloning
;;
...
echo ""
echo -e "\t$red[1]$yellow [[$white      DroneSploit        $yellow]] $white: "
echo -e "\t$red[2]$yellow [[$white   Drone Hacking Tool    $yellow]] $white: "
...
mkdir Dronesploit
cd RealTimeVoiceCloning 
sudo git clone https://github.com/dhondta/dronesploit.git 
clear 
cd ..
echo -e "$lightgreen"" +-+-+-+-+-+   +-+-+-+-+-+ "
echo -e "$red""   |D|r|o|n|e|   |T|o|o|l|s| "
echo -e "$lightgreen""+-+-+-+-+-+   +-+-+-+-+-+ "
echo -e $ [!] $yellow'Check out the Tool in the Directory' $lightgreen "/Skull" &&sleep 2 &&Drone
;;
...
mkdir DroneHacking
cd DroneHacking 
sudo git clone https://github.com/HKSSY/Drone-Hacking-Tool.git
clear 
cd ..
echo -e "$lightgreen"" +-+-+-+-+-+   +-+-+-+-+-+ "
echo -e "$red""   |D|r|o|n|e|   |T|o|o|l|s| "
